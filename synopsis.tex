...
\subsubsection*{Klangverhaltensmuster}
\begin{description}
  \item[Beugung] eher bei niedrigen Frequenzen, kleinen Hindernissen
  \item[Reflexion] eher bei hohen Frequenzen, glatten Flächen
\end{description}

\subsubsection*{Klangpositionierung}

3D-Positionierung von virtuellen Klangquellen im Raum\\
Stereo: ``nur links/rechts''\\
Phasenverschiebung und Amplitudenunterschiede realisierbar\\
HRTF rechenaufwändig aber weit verbreitet
